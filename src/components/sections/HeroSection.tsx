  ...
  return (
    <div className="mx-[-1rem] md:mx-[-12px] mt-[-1rem] md:mt-[-2rem] mb-16">
      <section className="relative overflow-hidden bg-panel/10 backdrop-blur-sm px-8 py-20 md:px-[12px] md:py-32 flex flex-col justify-center">
        ...
        <div className="relative z-10 w-full flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 xl:gap-20 2xl:gap-32 px-4 md:px-8">
          {photoUrl && (
            <div className="relative w-48 h-48 sm:w-56 sm:h-56 lg:w-64 lg:h-64 xl:w-80 xl:h-80 rounded-full overflow-hidden p-[4px] shadow-2xl flex-shrink-0 group z-30 shadow-primary/10">
          ...
          <div className="space-y-6 max-w-4xl flex-1 text-center lg:text-left">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 text-xs font-bold tracking-wider text-primary uppercase bg-primary/10 border border-primary/20 rounded-full mx-auto lg:mx-0">
